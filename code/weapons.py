...
class Weapon(pygame.sprite.Sprite):
    def __init__(self, player, groups):
        ...
        direction = player.action.split('_')[0]
        full_files = f'../graphics/weapons/{player.arsenal_weapon}/{direction}.png'
        self.image = pygame.image.load(full_files).convert_alpha()
        if direction == 'right':
